...
- Name: critical-flows.spec.ts >> Auth protection >> backtest page redirects to login when not authenticated
- Location: tests\critical-flows.spec.ts:37:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/backtest
Call log:
  - navigating to "http://localhost:3000/backtest", waiting until "load"
