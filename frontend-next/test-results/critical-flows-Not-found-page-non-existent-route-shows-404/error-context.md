...
- Name: critical-flows.spec.ts >> Not found page >> non-existent route shows 404
- Location: tests\critical-flows.spec.ts:75:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/this-page-does-not-exist-xyz
Call log:
  - navigating to "http://localhost:3000/this-page-does-not-exist-xyz", waiting until "load"
