...
const activeAsset: AssetType = 'silver';
    ...
    <DashboardLayout fullHeight>
      ...
      <div className="flex items-center justify-between border-b border-terminal-rule bg-terminal-panel px-4 py-2 mb-0">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-[10px] font-mono font-black text-[#b0b8c8] tracking-[0.2em] uppercase">
            XAG/USD — SILVER SPOT
          </span>
        </div>
        ...
        <div className="flex items-center gap-6">
          ...
          <button
            ...
            className={cn(
              'p-1 text-terminal-label hover:text-[#b0b8c8] transition-all',
              isRefetching && 'animate-spin text-[#b0b8c8]'
            )}
