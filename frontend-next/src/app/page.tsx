...
export default function Home() {
  return (
    <main className="min-h-screen flex flex-col items-center justify-center bg-[#040405] text-[#e8e4dc] p-6 relative">
      ...
      {/* ── Vault-light: single warm volumetric glow ── */}
      <div
        className="absolute top-0 left-1/2 -translate-x-1/2 w-[900px] h-[600px] pointer-events-none"
        style={{
          background: 'radial-gradient(ellipse at 50% 0%, rgba(212,175,55,0.07) 0%, rgba(212,175,55,0.03) 35%, transparent 70%)',
        }}
      />

      {/* ── Secondary cool glow behind dashboard for depth ── */}
      <div
      ...
      <div className="relative z-10 flex flex-col items-center text-center space-y-12 max-w-5xl w-full">
        ...
        <div className="space-y-6">
          ...
          <p className="text-lg md:text-xl text-[#8a8578] max-w-xl mx-auto leading-relaxed tracking-wide">
        ...
        <div className="flex flex-col items-center gap-4">
          <div className="flex flex-col sm:flex-row items-center gap-5">
            ...
            <Link
              ...
              className="text-sm font-medium text-[#8a8578] hover:text-[#d4af37] transition-colors duration-300 py-2"
            >
        ...
        <div className="relative w-full max-w-4xl mt-4">
          ...
          <div className="rounded-2xl border border-[#d4af37]/20 bg-[#0a0b0f] overflow-hidden shadow-[0_0_80px_-20px_rgba(212,175,55,0.06)]">
            ...
            <div className="flex items-center gap-1.5 px-4 py-3 border-b border-white/[0.04] bg-[#0c0d12]">
              ...
              <span className="ml-2 text-[10px] font-mono text-[#8a8578]/60 tracking-[0.15em] uppercase">
                MetalMind SMCForge
              </span>
            </div>
            {/* Terminal body */}
                  ...
                  <div className="space-y-2 mt-2">
                    {[0.42, 0.31, 0.26, 0.19, 0.14].map((w, i) => (
                      <div key={i} className="flex items-center gap-2">
                        ...
                        <span className="text-[7px] font-mono text-[#8a8578]/60 w-7 text-right tabular-nums">
                          {(w * 0.82).toFixed(2)}
                        </span>
                      </div>
                    ))}
