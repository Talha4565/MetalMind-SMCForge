...
class TestEngineerAllFeatures:
    ...
    def test_adds_many_features(self, small_ohlcv_df):
    ...
    def test_labels_added_when_requested(self, small_ohlcv_df):
        result = engineer_all_features(small_ohlcv_df, add_labels=True, asset='gold')
        assert 'target' in result.columns

    def test_no_labels_when_disabled(self, small_ohlcv_df):
        result = engineer_all_features(small_ohlcv_df, add_labels=False, asset='gold')
    ...
    def test_no_nans_in_output(self, small_ohlcv_df):
        result = engineer_all_features(small_ohlcv_df, add_labels=False, asset='gold')
    ...
    def test_gold_vs_silver_features(self, small_ohlcv_df):
    ...
    def test_with_mtf_columns(self, small_ohlcv_df):
    ...
    def test_feature_count_reasonable(self, small_ohlcv_df):
        result = engineer_all_features(small_ohlcv_df, add_labels=True, asset='gold')
